...
window.helpers = {
  ...
  drawDualChart(canvas, leftSeries, rightSeries) {
    ...
    ctx.fillStyle='#60a5fa'; ctx.fillRect(left,6,12,3); ctx.fillStyle='#cfe5ff'; ctx.font='11px sans-serif'; ctx.textAlign='left'; ctx.fillText('Total Volume', left+16,10);
    ctx.fillStyle='#22c55e'; ctx.fillRect(left+98,6,12,3); ctx.fillStyle='#d6ffe4'; ctx.fillText('Avg Weight', left+114,10);
  }
};
